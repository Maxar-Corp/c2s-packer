...
func TestAMIConfigPrepare_regions(t *testing.T) {
	...
	c.AMIRegions = []string{"us-iso-east-1", "us-iso-west-1", "us-iso-east-1"}
	if err := c.Prepare(nil, nil); err != nil {
		t.Fatalf("bad: %s", err)
	}

	expected := []string{"us-iso-east-1", "us-iso-west-1"}
	...
	c.AMIRegions = []string{"us-iso-east-1", "us-iso-east-2", "us-iso-west-1"}
	c.AMIRegionKMSKeyIDs = map[string]string{
		"us-iso-east-1": "123-456-7890",
		"us-iso-west-1": "789-012-3456",
		"us-iso-east-2": "456-789-0123",
	}
	if err := c.Prepare(nil, nil); err != nil {
		t.Fatal("shouldn't have error")
	}
	...
	c.AMIRegions = []string{"us-iso-east-1", "us-iso-west-1"}
	c.AMIRegionKMSKeyIDs = map[string]string{
		"us-iso-east-1": "123-456-7890",
		"us-iso-west-1": "789-012-3456",
		"us-iso-east-2": "456-789-0123",
	...
	c.AMIRegions = []string{"us-iso-east-1", "us-iso-west-1", "us-iso-east-2"}
	c.AMIRegionKMSKeyIDs = map[string]string{
		"us-iso-east-1": "123-456-7890",
		"us-iso-west-1": "789-012-3456",
	}
	...
	accessConf := getFakeAccessConfig("us-iso-east-1")
	c.AMIRegions = []string{"us-iso-east-1", "us-iso-west-1", "us-iso-east-2"}
